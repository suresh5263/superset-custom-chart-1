...
export default function SupersetPluginChartBulletV2(props) {
  ...
  const legend = data.map((d, i) => /*#__PURE__*/React.createElement("div", {
    ...
    className: "tooltip"
  }, data[i].count ? data[i].count : data[i].sum__num), /*#__PURE__*/React.createElement("div", {
    className: "tickNums ticksTop tickPointer",
    style: {
      width: '100%',
      textAlign: 'center'
    }
  }, data[i][data[i].count ? 'count' : 'sum__num'] === indicatorPosition ? /*#__PURE__*/React.createElement("img", {
  ...
  }, /*#__PURE__*/React.createElement("div", null, data[i].metricvalue))));
